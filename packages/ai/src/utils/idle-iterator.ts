...
const DEFAULT_OPENAI_STREAM_IDLE_TIMEOUT_MS = 360_000;
const DEFAULT_ANTHROPIC_STREAM_IDLE_TIMEOUT_MS = 360_000;
const DEFAULT_STREAM_FIRST_EVENT_TIMEOUT_MS = 120_000;
 ...
 * Anthropic has no built-in inter-event watchdog; a silently-dropped TCP connection
 * can cause the for-await loop to hang indefinitely without this guard.
 *
