...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["pi", "model", "plan_mode", "path", "git", "pr", "bg_jobs", "context_pct", "token_total", "cost"],
		rightSegments: [],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "plan_mode", "path", "git", "pr", "subagents", "bg_jobs"],
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "plan_mode", "path", "git", "pr", "session", "subagents", "bg_jobs"],
		rightSegments: [
			"token_in",
			"token_out",
			"cache_read",
